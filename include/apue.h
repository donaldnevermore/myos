...
int recv_fd(int, ssize_t (*func)(int, const void *, size_t)); /* Figures 17.21 and 17.23 */
...
#ifdef TIOCGWINSZ
pid_t pty_fork(int *, char *, int, const struct termios *, const struct winsize *); /* Figure 19.11 */
#endif
